...
Write-Host "    .\scripts\setup_laptop_winrm_trust.ps1 -PcTailscaleIp $tailscaleIp"
Write-Host ""
Write-Host "Then close the Administrator window and, from the normal laptop account, save and verify the credential once:"
Write-Host "    .\scripts\save_laptop_pc_winrm_credential.ps1 -PcTailscaleIp $tailscaleIp -PcWindowsUser $thisUser"
Write-Host ""
Write-Host "Future remote commands will not prompt for the password:"
