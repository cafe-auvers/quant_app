...
| `KIS_LIVE_EXECUTION_MODE`, `KIS_CONTROLLED_LIVE_MAX_ENTRY_EQUITY_FRACTION`, `KIS_CONTROLLED_LIVE_MAX_ENTRY_NOTIONAL` | Controlled-live policy and execution gateway | Additional disabled/controlled/full-live envelope; controlled live takes eligible symbols from persisted active Trade Cards and caps each entry against fresh account NAV plus any optional fixed USD ceiling |
